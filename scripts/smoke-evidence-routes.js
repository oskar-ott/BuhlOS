...
(async function main() {
  ...
  await expectStatus(
    "HTML  /phil/jobs/birdwood-iv3232/itps/itp_smoke (gated → 307)",
    `${base}/phil/jobs/birdwood-iv3232/itps/itp_smoke`,
    { expect: { status: [307] } }
  );
  await expectStatus(
  ...
  await expectStatus(
    "HTML  /v2/jobs/birdwood-iv3232 (admin job hub, gated → 307)",
    `${base}/v2/jobs/birdwood-iv3232`,
    { expect: { status: [307] } }
  );
  await expectStatus(
