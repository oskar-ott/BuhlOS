// admin-icons.jsx — lucide-style stroke icon set for BuhlOS Admin.
// One <Ic n="briefcase" s={16} /> component; paths mirror lucide-react so the
// sidebar, command-centre queue cards and job-hub section nav read the same
// vocabulary as the real build. Exports Ic to window.
...
const ICONS = {
  ...
  // ── Command centre queues ──────────────────────────────────────
  "camera": `<path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/>`,
  "alert-octagon": `<path d="M7.86 2h8.28L22 7.86v8.28L16.14 22H7.86L2 16.14V7.86z"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/>`,
  ...
  "pencil-ruler": `<path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/>`,
...
function Ic({ n, s = 16, sw = 2, cls = "", style }) {
  return (
    <svg className={"ic " + cls} width={s} height={s} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round"
      style={{ flexShrink: 0, display: "block", ...(style || {}) }}
      dangerouslySetInnerHTML={{ __html: ICONS[n] || ICONS["circle"] }} />
  );
}
