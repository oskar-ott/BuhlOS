...
| # | Doc | Purpose | Who should read | When |
| --- | --- | --- | --- | --- |
| 32 | [32-phase-e-plan.md](32-phase-e-plan.md) | Phase E umbrella scope (ITP / RFI / Materials), E1 recommended scope (ITP field-record + admin sign-off loop), data model, routes, audit, permissions, risks, decisions §15.1 (6 founder calls). E2/E3/E4 explicitly deferred to their own plans. Docs-only. | Phase E planning approval (Oskar). Future E1 build sessions. | After D.5 hardening ships (PR #26 merged); before any E1 build prompt is run. |
