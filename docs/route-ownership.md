...
| `/invoices/[invoiceId]` | `src/app/(admin)/invoices/[invoiceId]/page.tsx` | Supplier-invoice review (PDF beside extracted values, exact IV match reason, confirm / exclude / archive). Same gates. |
