...
| `xero_connection` | admin-tier | 2026-12-31 | The Xero connection + read-only payroll reference sync — `api/xero/*` + `/settings/integrations/xero` (#247/#610). Read-only: no Xero write exists behind this flag; the timesheet push (#249) gets its own independent gate |
