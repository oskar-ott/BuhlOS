...
(function () {
  ...
  const NAV = [
    ...
    { id: 'job-builder', label: 'Job Builder',    href: '/admin/job-builder', icon: 'stage',    roles: ['admin'] },
    { id: 'hours',       label: 'Hours & costs',  href: '/admin/hours',       icon: 'hours' },
    { id: 'itp',         label: 'ITP / QA',       href: '/admin/itp',         icon: 'stage' },
    { id: 'plans',       label: 'Plans & docs',   href: '/admin/plans',       icon: 'today' },
    ...
    { id: 'variations',  label: 'Variations',     href: '/admin/variations',  icon: 'quote',    roles: ['admin'] },
    { section: 'Insights', roles: ['admin'] },
    { id: 'reports',     label: 'Reports',        href: '/admin/reports',     icon: 'today',    roles: ['admin'] },
