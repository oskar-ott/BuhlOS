...
const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  "invoice.corrected": "Corrected supplier invoice details",
  "invoice.job_selected": "Chose the job for a supplier invoice",
  "invoice.confirmed": "Confirmed a supplier invoice cost",
