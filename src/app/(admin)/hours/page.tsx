 ...
 * week at the end of it — so the section opens on the Mon–Sun week, not on a
 * today view that reads empty four days out of five. The day view lives on at
 * /hours/today (same page, moved); every deep link to /hours keeps working
 * via this redirect, so the URL stays sacred.
 *
