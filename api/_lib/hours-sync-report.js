...
//
// Lives under api/_lib (app code) so the scheduled cron route and the manual
// runner share ONE source of truth; scripts/importers/lib/hours-sync-report.js
// is a thin re-export for the importer + its tests' existing import path.
//
...
const { canonicaliseAllocations } = require('./alloc-pg');
