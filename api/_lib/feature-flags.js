...
const FLAG_PRESENTATION = {
  ...
  jobs: { label: 'Jobs', domain: 'Jobs', surface: 'Shared', core: true },
  hours: { label: 'Hours', domain: 'Hours', surface: 'Shared', core: true },
  evidence: { label: 'Evidence', domain: 'Field capture', surface: 'Shared', core: true },
  observations_inbox: { label: 'From site (observations)', domain: 'Field capture', surface: 'Shared' },
  material_requests: { label: 'Material requests', domain: 'Commercial', surface: 'Shared' },
  expenses: { label: 'Expenses', domain: 'Commercial', surface: 'Shared' },
  quotes: { label: 'Quotes', domain: 'Commercial', surface: 'BuhlOS' },
  defects: { label: 'Defects', domain: 'QA & compliance', surface: 'BuhlOS' },
  dayworks: { label: 'Dayworks', domain: 'Commercial', surface: 'BuhlOS' },
  employees: { label: 'Employees', domain: 'People & gear', surface: 'BuhlOS' },
  gear: { label: 'Gear / test & tag', domain: 'People & gear', surface: 'BuhlOS' },
  reports: { label: 'Reports', domain: 'Company', surface: 'BuhlOS' },
  job_photos: { label: 'Photos (Job Bible)', domain: 'Field capture', surface: 'Shared' },
  snags: { label: 'Snags', domain: 'Field capture', surface: 'Shared' },
  scope_reconciliation: { label: 'Scope reconciliation', domain: 'Jobs', surface: 'BuhlOS' },
  job_control: { label: 'Job control (required proof)', domain: 'Jobs', surface: 'Shared' },
  closeout: { label: 'Closeout', domain: 'QA & compliance', surface: 'BuhlOS' },
  documents: { label: 'Documents & specs', domain: 'Site records', surface: 'Shared' },
  circuit_schedule: { label: 'Circuit schedules', domain: 'QA & compliance', surface: 'Shared' },
  diary: { label: 'Site diary', domain: 'Site records', surface: 'BuhlOS' },
  job_activity: { label: 'Activity (audit trail)', domain: 'Platform', surface: 'BuhlOS' },
};
